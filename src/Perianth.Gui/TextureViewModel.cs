...
public sealed class TextureViewModel : ViewModelBase
{
    ...
    private bool MistypedParts()
    {
        ...
        Status = "The parts box wants part numbers separated by commas — or leave it empty to change "
            + "every part painted with this texture. A part's number is the N in mode3-record-N, "
            + "which you can read off an exported GLB in Blender.";
        return true;
    }
    ...
    /// </remarks>
    private void Apply(Result<MaterialEditOutcome> edit, Func<MaterialEditOutcome, string> describe)
    {
